        ...
        <div>
           ...
           <Modal isShow={isShow} onClose={state => setIsShow(state)}>
               <form onSubmit={handleSubmit}>
                   ...
                   <div className="sticky top-0 bg-white px-5 pt-5 pb-3 shadow">
                       <div className="w-full flex items-center">
                           <div className="flex flex-col">
                               ...
                               <small className="text-slate-400 text-sm">Users with active roles cannot be deleted.</small>
                           </div>
                   ...
                   {/* modal body */}
                   <div className="p-5">
                       Are you sure you want to delete this user <strong>{user.name}</strong> ({user.email}) with role <strong>{user.role}</strong>?
                   </div>
                   {/* end modal body */}
