...
app.put(`/:id`, [authorization_1.verifyToken, (0, authorization_1.verifyRole)(["CASHIER", "MANAGER"]), orderValidation_1.verifyEditStatus], orderController_1.updateStatusOrder);
